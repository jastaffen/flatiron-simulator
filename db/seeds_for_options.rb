...
#comm_happy_hour
# option14 = Option.create(text: "drink (no pressure though..almond milk acceptable)", from_scene_id: 5, to_scene_id: 6)
# option15 = Option.create(text: "drink while playing banagrams", from_scene_id: 5, to_scene_id: 6)
# option16 = Option.create(text: "drink whlie playing pong (and drinking more)", from_scene_id: 5, to_scene: 6)
# option17 = Option.create(text: "do labs, be antisocial, but maybe with a beer?", from_scene_id: 5, to_scene_id: 6)
